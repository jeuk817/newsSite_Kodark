...
public class ArticleController {
	...
	public ResponseEntity<List<Map<String, Object>>> getEmotionInfo(@RequestParam("articleId") int articleId,
		...
		try {
			...
			for (int i = 0; i < pSize; i++) {
				sb.append("</article/emotion?articleId=" + articleId + "&emotion=" + params.get(i).get("emotion") + ">;"
	...
	/**
	 * 대댓글 데이터 날짜 : 2021-01-07 작성자 : 이종현
	 */
	@GetMapping(path = "/comment")
	public ResponseEntity<List<Map<String, Object>>> getCommentReply(@RequestParam("articleId") int articleId,
