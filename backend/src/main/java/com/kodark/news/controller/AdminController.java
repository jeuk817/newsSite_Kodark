...
public class AdminController {
	...
	public ResponseEntity<List<Map<String, Object>>> mainPage() {
		...
		return new ResponseEntity<List<Map<String, Object>>>(statisticsService.execuStatisticsProcedure(_id),
				HttpStatus.OK);// 200
	}
	...
	public ResponseEntity<List<Map<String, Object>>> waitingArticle() {
		return new ResponseEntity<List<Map<String, Object>>>(adminProcedureService.getWaitArticles(),
	...
	public ResponseEntity<Map<String, Object>> reportNavi(HttpServletResponse response) {
		...
		response.setHeader("Links",
				"</admin/statistics>; rel=\"statistics\"," + "</admin/users?userStartId>; rel=\"userList\","
