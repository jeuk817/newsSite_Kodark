...
public interface ArticleProcedureMapper {
	...
	@Select(value = "{CALL article_procedure("
			...
			+ ",#{_article_id, mode=OUT, jdbcType=INTEGER, javaType=java.lang.String}"
			+ ",#{_reporter_id, mode=OUT, jdbcType=INTEGER, javaType=java.lang.String}"
			+ ",#{result_set, mode=INOUT, jdbcType=VARCHAR, javaType=java.lang.String}"
			+ ")}")
